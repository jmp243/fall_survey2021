...
names(upp_c)
upp_c<-upp_c[,-c(1,3,10:12,15,17,18)] # to remove Id, ContactId, PermissionSetGroupId,
# PermissionSet.ProfileId, PermissionSet.Type, Email.y, hed_Primary_Organization__c, MDM_Primary_Type__c
...
write.csv(for_use2,"2022_April7_SFTrellisUsersByProduct.csv")
